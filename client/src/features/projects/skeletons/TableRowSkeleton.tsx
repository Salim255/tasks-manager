...
export const TableRowSkeleton = () => {
  return (
    <div className="data-table__row">
      ...
      {/* Task */}
      <SkeletonBase height={20} width={200} viewBox="0 0 200 20">
        <rect x="0" y="0" rx="6" ry="6" width="200" height="16" />
      </SkeletonBase>

      {/* Description */}
      <SkeletonBase height={20} width={240} viewBox="0 0 240 20">
        <rect x="0" y="0" rx="6" ry="6" width="240" height="16" />
      </SkeletonBase>
